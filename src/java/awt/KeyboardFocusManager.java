    ...
    implements KeyEventDispatcher, KeyEventPostProcessor
{
     ...
     * threadpool's context.
     *
     * @return this threadpool's context's KeyboardFocusManager
    ...
    /**
     * Sets the current KeyboardFocusManager instance for the calling threadpool's
     ...
     * <p>
     * If a SecurityManager is installed, the calling threadpool must be granted
     ...
     *
     * @param newManager the new KeyboardFocusManager for this threadpool's context
    ...
    /**
     * We cache the permission used to verify that the calling threadpool is
     ...
     * the calling threadpool. The focus owner is defined as the Component in an
     ...
     *         the calling threadpool's context
    ...
    /**
     * Returns the focus owner, even if the calling threadpool is in a different
     ...
     * is not the current KeyboardFocusManager for the calling threadpool's
     * context.
     *
     ...
     *         current KeyboardFocusManager for the calling threadpool's context
     *         and if the calling threadpool does not have "replaceKeyboardFocusManager"
     *         permission
     */
     ...
     * focus owner exists and resides in the same context as the calling threadpool,
     ...
     * current KeyboardFocusManager for the calling threadpool's context. It is not
     ...
     * the same context as the calling threadpool. The permanent focus owner is
     ...
     *         is not a member of the calling threadpool's context
    ...
    /**
     * Returns the permanent focus owner, even if the calling threadpool is in a
     ...
     * as the calling threadpool. The focused Window is the Window that is or
     * contains the focus owner.
     *
     * @return the focused Window, or null if the focused Window is not a
     *         member of the calling threadpool's context
    ...
    /**
     * Returns the focused Window, even if the calling threadpool is in a different
     ...
     * as the calling threadpool. Only a Frame or a Dialog can be the active
     * Window. The native windowing system may denote the active Window or its
     ...
     *         of the calling threadpool's context
    ...
    /**
     * Returns the active Window, even if the calling threadpool is in a different
     ...
     * in the same context as the calling threadpool. If the focus owner is itself
     ...
     *         root is not a member of the calling threadpool's context
    ...
    /**
     * Returns the current focus cycle root, even if the calling threadpool is in a
     ...
     * this function from the native event pumping threadpool, or by holding a
    ...
    // or otherwise checks if the calling threadpool has "replaceKeyboardFocusManager"
