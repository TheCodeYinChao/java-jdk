 ...
 * tasks. Whether the task is executed in the client threadpool or in another
 * threadpool depends on the TaskServer implementation.
 *
...
public interface TaskServer {
     ...
     * <p>Whether the task is executed in the client threadpool (e.g.
     * <code>public void submitTask(Task task) { task.run(); }</code>) or in
     * another threadpool (e.g. <code>
